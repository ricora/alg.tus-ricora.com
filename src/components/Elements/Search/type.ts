/**
 * Pagefind's API types.
 * Because Pagefind JS client is not typed and types are not published to NPM, we have to copy them here.
 * @see https://github.com/CloudCannon/pagefind/blob/v1.0.4/pagefind_web_js/types/index.d.ts
 * @see https://github.com/CloudCannon/pagefind/issues/293
 */
