...
- [Better Comments](https://marketplace.visualstudio.com/items?itemName=aaron-bond.better-comments)
  - コメントアウトの後に`*`, `!`, `?`, `TODO:`などをつけることで、コメントアウトをカラフルにできる。
...
また、細かい設定の値については、実際のThemeのソースコード([GitHub Theme](https://github.com/primer/github-vscode-theme))や[公式ドキュメント](https://code.visualstudio.com/api/references/theme-color)を参考にしてください。
